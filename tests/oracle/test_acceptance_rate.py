...
from FlashSpec.Engine.oracle.cache_utils import TopKCache
from FlashSpec.Engine.oracle.model_utils import enable_topk, disable_topk
...
for step, batch in pbar:
    ...
    with torch.inference_mode():
        ...
        past_key_values.crop(initial_len)

        # create topk cache
        past_key_values = TopKCache.from_fullcache(past_key_values, initial_len, args.budget)

        enable_topk(model)

        # have to get draft_logits autoregressively
